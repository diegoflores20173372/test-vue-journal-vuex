<template>
  ...
  <img src="https://www.ngenespanol.com/wp-content/uploads/2018/08/La-primera-imagen-de-la-historia-1280x720.jpg"
...
export default {
  name: "EntryView",
  components: {
    FabEntry: defineAsyncComponent(() => import('../components/FabEntry'))
  }
}
</script>
